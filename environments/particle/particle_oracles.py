...
class ParticleOracle(py_policy.PyPolicy):
    ...
    def __init__(
        self, env, wait_at_first_goal=1, multimodal=False, goal_threshold=0.01
    ):
        """Create oracle.
