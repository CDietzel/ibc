...
class BlockPushMultimodal(block_pushing.BlockPush):
    ...
    def get_metrics(self, num_episodes):
        metrics = [
            block_pushing_metrics.AverageSuccessMetric(self, buffer_size=num_episodes)
        ]
...
registration.register(
    id="BlockPushMultimodal-v0", entry_point=BlockPushMultimodal, max_episode_steps=200
)
registration.register(
