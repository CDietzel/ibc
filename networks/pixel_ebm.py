...
class PixelEBM(network.Network):
    ...
    def __init__(
        ...
        self._encoder = get_encoder_network(
            encoder_network, target_height, target_width, num_channels
        )
    ...
    def encode(self, obs, training):
        ...
        images = image_prepro.preprocess(
            images, target_height=self.target_height, target_width=self.target_width
        )
